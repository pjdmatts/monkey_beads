...
# Styles and scripting for the page. I moved the custom css into its own file
main_page_head = '''
<head>
    <meta charset="utf-8">
      ...
      <div class="navbar navbar-fixed-top" role="navigation">
        <div class="container">
          <div class="navbar-header">
			...
			<p class="navbar-text">'In a world learning to code...'</p>
          </div>
        </div>
      </div>
    </div>
...
# A single movie entry html template, updated to include the storyline
movie_tile_content = '''
